function [ESN_Quarterly_2B,ESN_Monthly_2B] = Hyperparameter_selection2B(Training_data,N_Monthly,N_Quarterly,neurons)
...
lb = [-10000,0.1,0.001,0,-100000,-10000,0.1,0.001,-10000];
ub = [100000,100,1,1000000000,10000,100000,100,1,-10000];
nonlcon = [];
...
for i = 1:size(neurons,2)
    ...
    fun3 = @(theta3) Cross_validation2B(theta3, Training_data, ESN_hyper_Quarter,ESN_hyper_Month);
...
[~,ESN_Quarterly_2B,ESN_Monthly_2B,~] = Scaling('Model2',ESN_temp_Quarter,theta_temp,ESN_temp_Monthly);
