function [Avg_error] = Cross_validation3(theta3, Training_data, ESN_hyper)
%CROSS_VALIDATION1 Summary of this function goes here
%   Detailed explanation goes here
% ESN=ESN_hyper
% theta3 =[1.2,1.1,0.8,.36] [gamma, rho, alpha, lambda] optimizing 4 params

[~,~,~,ESN_hyper] = Scaling('Model3',ESN_hyper, theta3);
...
for i = 1:kfold
    ...
    [~,~,~,MSE_Error] = ESN_func_Model3(Total_kfold_data,training_length-1,ESN_hyper);
